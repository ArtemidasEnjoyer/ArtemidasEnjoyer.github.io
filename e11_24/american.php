...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <?php
            $zapytanie2 = "SELECT DISTINCT swinki.data_ur,swinki.miot,rasy.rasa FROM swinki JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy.id = 6";
            ...
            <?php
            $zapytanie3 = "SELECT swinki.imie,swinki.cena,swinki.opis FROM swinki WHERE swinki.rasy_id = 6;";
